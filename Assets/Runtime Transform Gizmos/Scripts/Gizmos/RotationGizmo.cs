...
namespace RTEditor
{
    ...
    public class RotationGizmo : Gizmo
    {
        ...
        public override bool IsReadyForObjectManipulation()
        {
            ...
            return _selectedAxis != GizmoAxis.None || _isRotationSphereSelected || _isCameraLookRotationCircleSelected;
        }
        ...
        protected override void Update()
        {
            ...
            float t;
            if (_selectedAxis == GizmoAxis.None && !_isCameraLookRotationCircleSelected &&
