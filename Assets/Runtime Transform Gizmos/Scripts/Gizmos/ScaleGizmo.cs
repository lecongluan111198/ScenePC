...
namespace RTEditor
{
    ...
    public class ScaleGizmo : Gizmo
    {
        ...
        protected override void OnLeftMouseButtonDown()
        {
            ...
            if (_selectedAxis != GizmoAxis.None || _selectedMultiAxisTriangle != MultiAxisTriangle.None)
            {
        ...
        private void DrawMultiAxisTriangles(Matrix4x4[] worldTransforms)
        {
            ...
            for (int multiAxisIndex = 0; multiAxisIndex < 3; ++multiAxisIndex)
            {
                Color multiAxisColor = multiAxisIndex == (int)_selectedAxis ? _selectedMultiAxisTriangleColor : _multiAxisTriangleColors[multiAxisIndex];
